    ...
    <div class="space-y-6">
        ...
        >
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                <p class="font-medium">{{ $t('settings.delete.warning_title') }}</p>
                <p class="text-sm">
                    {{ $t('settings.delete.warning_message') }}
                </p>
            </div>
            <Dialog>
                ...
                <DialogContent>
                    ...
                    >
                        <DialogHeader class="space-y-3">
                            <DialogTitle
                                >{{ $t('settings.delete.confirm_title') }}</DialogTitle
                            >
                            <DialogDescription>
                        ...
                        <div class="grid gap-2">
                            <Label for="password" class="sr-only"
                                >{{ $t('settings.delete.password') }}</Label
                            >
                            <Input
                                id="password"
                                type="password"
